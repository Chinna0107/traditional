        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <a href="https://www.instagram.com/mokshamandir.in?igsh=MXJlNmYyYXJmZWp1NQ==" className="w-8 h-8 rounded-full bg-brand-gold/20 flex items-center justify-center text-brand-gold hover:bg-brand-gold hover:text-[#5C4033] transition-colors">
